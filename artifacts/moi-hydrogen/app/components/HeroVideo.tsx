  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: [
            `radial-gradient(ellipse 70% 50% at 0% 50%, ${HERO_GRAD_EDGE} 0%, transparent 70%)`,
            `radial-gradient(ellipse 70% 50% at 100% 50%, ${HERO_GRAD_EDGE} 0%, transparent 70%)`,
            `radial-gradient(ellipse 100% 40% at 50% 100%, ${HERO_GRAD_EDGE} 0%, transparent 60%)`,
          ].join(", "),
        }}
      />
      ...
      <div
        ...
        style={{ background: "linear-gradient(180deg, rgba(0,0,0,0.28) 0%, rgba(0,0,0,0.03) 30%, rgba(0,0,0,0.03) 50%, rgba(0,0,0,0.62) 100%)" }}
      />
      <div
        className="absolute inset-0 z-[2] pointer-events-none"
        style={{ background: "radial-gradient(ellipse 110% 100% at 50% 50%, transparent 50%, rgba(0,0,0,0.42) 100%)" }}
      />
      ...
      >
        ...
        <motion.h1
          style={{ color: "#fff", fontSize: "clamp(5.41rem, 22vw, 13.52rem)", letterSpacing: "0.03em", lineHeight: 0.88, fontFamily: "'Cormorant Garamond', Georgia, serif", fontWeight: 500, textShadow: "0 2px 12px rgba(0,0,0,0.35)" }}
        ...
        <motion.button
          ...
          style={{ color: "#fff", borderColor: "rgba(255,255,255,0.48)", backdropFilter: "blur(6px)", WebkitBackdropFilter: "blur(6px)", backgroundColor: "rgba(255,255,255,0.07)", fontFamily: "'Montserrat', sans-serif", fontSize: "9px", letterSpacing: "0.45em", padding: "14px 36px", textTransform: "uppercase" }}
        >
          Shop Now
        </motion.button>
      ...
      >
        <motion.div
          ...
          style={{ width: 1, height: 44, background: "linear-gradient(to bottom, rgba(255,255,255,0), rgba(255,255,255,0.6))", margin: "0 auto", transformOrigin: "top" }}
        />
      </motion.div>
    </section>
  );
