          ...
          >
            ...
            {hasItems && (
              ...
              >
                ...
                {/* <DiscountBanner /> */}
                {canUseApplePay() && isShopify && shopifyCart && shopifyCart.lines.nodes.length > 0 && (
                  <ShopifyApplePayButton
                    lines={shopifyCart.lines.nodes.map((l) => ({ variantId: l.merchandise.id, quantity: l.quantity }))}
