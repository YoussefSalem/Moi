 ...
 * PRODUCT 1 — Moi Versa Top
  ...
  product2: {
    ...
    ref: "2076/511/401",
    variants: [
      { id: "moi-versa-top-ivory-small",      title: "Ivory / Small",       availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "Ivory" },      { name: "Size", value: "Small"  }] },
      { id: "moi-versa-top-ivory-medium",     title: "Ivory / Medium",      availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "Ivory" },      { name: "Size", value: "Medium" }] },
      { id: "moi-versa-top-sand-small",       title: "Sand / Small",        availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "Sand" },       { name: "Size", value: "Small"  }] },
      { id: "moi-versa-top-sand-medium",      title: "Sand / Medium",       availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "Sand" },       { name: "Size", value: "Medium" }] },
      { id: "moi-versa-top-taupe-small",      title: "Taupe / Small",       availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "Taupe" },      { name: "Size", value: "Small"  }] },
      { id: "moi-versa-top-taupe-medium",     title: "Taupe / Medium",      availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "Taupe" },      { name: "Size", value: "Medium" }] },
      { id: "moi-versa-top-espresso-small",   title: "Espresso / Small",    availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "Espresso" },   { name: "Size", value: "Small"  }] },
      { id: "moi-versa-top-espresso-medium",  title: "Espresso / Medium",   availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "Espresso" },   { name: "Size", value: "Medium" }] },
      { id: "moi-versa-top-brown-small",      title: "Brown / Small",       availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "Brown" },      { name: "Size", value: "Small"  }] },
      { id: "moi-versa-top-brown-medium",     title: "Brown / Medium",      availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "Brown" },      { name: "Size", value: "Medium" }] },
      { id: "moi-versa-top-white-small",      title: "White / Small",       availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "White" },      { name: "Size", value: "Small"  }] },
      { id: "moi-versa-top-white-medium",     title: "White / Medium",      availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "White" },      { name: "Size", value: "Medium" }] },
      { id: "moi-versa-top-cashmere-small",   title: "Cashmere / Small",    availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "Cashmere" },   { name: "Size", value: "Small"  }] },
      { id: "moi-versa-top-cashmere-medium",  title: "Cashmere / Medium",   availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "Cashmere" },   { name: "Size", value: "Medium" }] },
      { id: "moi-versa-top-black-small",      title: "Black / Small",       availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "Black" },      { name: "Size", value: "Small"  }] },
      { id: "moi-versa-top-black-medium",     title: "Black / Medium",      availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "Black" },      { name: "Size", value: "Medium" }] },
      { id: "moi-versa-top-light-blue-small", title: "Light Blue / Small",  availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "Light Blue" }, { name: "Size", value: "Small"  }] },
      { id: "moi-versa-top-light-blue-medium",title: "Light Blue / Medium", availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "Light Blue" }, { name: "Size", value: "Medium" }] },
      { id: "moi-versa-top-navy-small",       title: "Navy / Small",        availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "Navy" },       { name: "Size", value: "Small"  }] },
      { id: "moi-versa-top-navy-medium",      title: "Navy / Medium",       availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "Navy" },       { name: "Size", value: "Medium" }] },
      { id: "moi-versa-top-mint-small",       title: "Mint / Small",        availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "Mint" },       { name: "Size", value: "Small"  }] },
      { id: "moi-versa-top-mint-medium",      title: "Mint / Medium",       availableForSale: true, inventoryQuantity: 5, price: "1.399 EGP", selectedOptions: [{ name: "Color", value: "Mint" },       { name: "Size", value: "Medium" }] },
    ],
    defaultInventory: {
