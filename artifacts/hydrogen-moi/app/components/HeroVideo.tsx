...
const HERO_VIDEO_URL = ''; // Set via VITE_HERO_VIDEO_URL or leave empty to use fallback image
const HERO_FALLBACK = '/hero-image.jpeg';
  ...
  return (
    <section
      ...
      style={{
        position: 'relative',
        height: '100svh',
        marginTop: 'calc(-1 * var(--header-offset, 0px))',
      }}
    >
      {!loaded && <ImageSkeleton variant="warm" className="z-[1]" />}
