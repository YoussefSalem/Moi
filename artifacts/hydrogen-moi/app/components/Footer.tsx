...
export function Footer() {
  const [openSection, setOpenSection] = useState<string | null>('return-policy');
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-center gap-6 mb-8">
          ...
          >
            ...
            />
            <span
              className="text-[11px] tracking-[0.25em] uppercase text-white/60 group-hover:text-white/90 transition-colors font-medium"
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
          ...
          <a
            href="https://www.tiktok.com/@shopmoi_"
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-2.5 transition-all duration-300 hover:opacity-100 opacity-70"
          >
        ...
        <div className="mb-10 border-t border-white/10 pt-8">
          <div className="flex items-center justify-between gap-4 mb-8">
            <div>
              <p
                className="text-[10px] tracking-[0.35em] uppercase text-white/45"
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                Moi
              </p>
              <p className="mt-3 max-w-xl text-sm md:text-base leading-7 text-white/65">
                Shop versatile tops, elegant clothing, and curated fashion accessories designed for
          ...
          {/* Accordion */}
          <div
            className="space-y-3 rounded-3xl bg-[#342b26] p-4 md:p-5"
        ...
        <div className="mt-12 pt-6 border-t border-white/10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1 mb-5">
            <a
              href="mailto:hello@buy-moi.com"
              className="text-[9px] tracking-[0.2em] text-white/25 hover:text-white/55 transition-colors duration-300"
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              hello@buy-moi.com
            </a>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-center">
            ...
            <p
              className="text-[10px] tracking-[0.22em] uppercase text-white/35"
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              Premium versatile tops.
            </p>
          </div>
        </div>
      </div>
