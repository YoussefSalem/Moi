...
import { Analytics, getSeoMeta, CartProvider } from '@shopify/hydrogen';
...
import { captureAttribution } from '~/lib/adAttribution.client';
    ...
    <html lang="en">
      ...
      <body>
        ...
        >
          ...
          <a
            href="/"
            className="mt-8 text-xs tracking-[0.3em] uppercase border px-6 py-3"
            style={{
              fontFamily: "'Montserrat', sans-serif",
              borderColor: '#1e1814',
              color: '#1e1814',
